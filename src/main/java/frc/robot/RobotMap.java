...
public class RobotMap {
    ...
    public static double WRIST_RETRACTED_ANGLE = 120;
    public static double WRIST_EXTENDED_ANGLE = 0;
    public static double WRIST_CARGO_ANGLE = 20;
    public static double WRIST_CARGO_INTAKE_ANGLE = 45;
    ...
    public static double ELEVATOR_HATCH_HIGH_POSITION = 63;
    ...
    public static double ELEVATOR_CARGO_INATAKE_GROUND_POSITION = 1.5;
    ...
    public static double ELEVATOR_CARGO_MID_POSITION = 45;
