...
//        SmartDashboard.putBoolean("isElevatorCalibrated", initialCalibration);
    ...
    public void initLogging() {
        BadLog.createTopic("Elevator/Left A Output Current", "A", () -> elevatorMotors[0].getOutputCurrent(),
                "hide", "join:Elevator/Output Currents");
        BadLog.createTopic("Elevator/Left B Output Current", "A", () -> elevatorMotors[1].getOutputCurrent(),
                "hide", "join:Elevator/Output Currents");
        BadLog.createTopic("Elevator/Right Output Current", "A", () -> elevatorMotors[2].getOutputCurrent(),
                "hide", "join:Elevator/Output Currents");
    }
    @Override
