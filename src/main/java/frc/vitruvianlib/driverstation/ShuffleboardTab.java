...
/**
 * The {@link } class is the bridge between robot programs and the SmartDashboard on
 * the laptop.
 *
...
public class ShuffleboardTab {
    ...
    /**
     * The {@link NetworkTable} used by {@link }.
     */
    private static NetworkTable table;

    public ShuffleboardTab(String tabName) {
        table = NetworkTableInstance.getDefault().getTable(tabName);
    }
